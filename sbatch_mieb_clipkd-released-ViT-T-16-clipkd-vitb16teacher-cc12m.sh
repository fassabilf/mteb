...
#SBATCH -t 25:00:00
#SBATCH -A lt200394
#SBATCH -J mieb_clipkd-released-ViT-T-16-clipkd-vitb16teacher-cc12m
...
python3 "/project/lt200394-thllmV/benchmark/mteb/eval_mieb.py" --model "fassabilf/clipkd-released-ViT-T-16-clipkd-vitb16teacher-cc12m"
